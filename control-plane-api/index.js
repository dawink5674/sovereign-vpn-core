...
const requireAuth = (req, res, next) => {
  ...
  const expectedKeyBuffer = Buffer.from(API_KEY);

  if (clientKeyBuffer.length !== expectedKeyBuffer.length || !crypto.timingSafeEqual(clientKeyBuffer, expectedKeyBuffer)) {
