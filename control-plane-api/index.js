...
// Admin API Key for securing provisioning and management endpoints
...
function requireAuth(req, res, next) {
  ...
  // Prevent length-extension/timing attacks by ensuring buffers are the same length before comparing
