...
// ---------------------------------------------------------------------------
// Authentication middleware — requires ADMIN_API_KEY environment variable
// ---------------------------------------------------------------------------
function requireAuth(req, res, next) {
  const adminKey = process.env.ADMIN_API_KEY;
  if (!adminKey) {
    console.error('CRITICAL: ADMIN_API_KEY is not set. Denying access to prevent fail-open.');
  ...
  // Prevent timing attacks and runtime length mismatch errors
