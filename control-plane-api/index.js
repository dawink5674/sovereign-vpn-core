...
// ---------------------------------------------------------------------------
// Authentication middleware — secures control plane API endpoints
// ---------------------------------------------------------------------------
function requireAuth(req, res, next) {
  const adminApiKey = process.env.ADMIN_API_KEY;

  // Fail-closed security posture: block access if no admin key is configured
  if (!adminApiKey) {
  ...
  // Prevent timing attacks during string comparison
