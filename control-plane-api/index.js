...
function requireAuth(req, res, next) {
  ...
  const adminKeyBuffer = Buffer.from(adminApiKey, 'utf-8');

  if (clientKeyBuffer.length !== adminKeyBuffer.length || !crypto.timingSafeEqual(clientKeyBuffer, adminKeyBuffer)) {
