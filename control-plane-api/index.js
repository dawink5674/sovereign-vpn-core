...
const requireAuth = (req, res, next) => {
  ...
  const expectedKeyBuffer = Buffer.from(adminApiKey, 'utf8');

  if (providedKeyBuffer.length !== expectedKeyBuffer.length || !crypto.timingSafeEqual(providedKeyBuffer, expectedKeyBuffer)) {
