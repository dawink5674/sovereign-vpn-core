...
app.post('/api/peers', async (req, res) => {
  try {
    ...
    // Validate base64 key is 44 chars (32 bytes base64-encoded) and contains only valid base64 characters
...
app.delete('/api/peers/:publicKey', async (req, res) => {
  ...
  // Validate base64 structure to prevent command injection
